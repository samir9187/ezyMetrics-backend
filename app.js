...
//     doc.fontSize(20).text("EzyMetrics Report", { align: "center" }).moveDown();
//     doc.fontSize(15).text("Leads Data:");
//     doc.fontSize(12).text(JSON.stringify(leadsData, null, 2)).moveDown();
//     doc.fontSize(15).text("Campaigns Data:");
...
app.get("/report/pdf", async (req, res) => {
  try {
    ...
    doc.fontSize(20).text("EzyMetrics Report", { align: "center" }).moveDown();
    doc.fontSize(15).text("Campaigns Data:");
    doc.fontSize(12).text(JSON.stringify(campaignsData, null, 2)).moveDown();
    doc.fontSize(15).text("Leads Data:");
    doc.fontSize(12).text(JSON.stringify(leadsData, null, 2));
    doc.end();
